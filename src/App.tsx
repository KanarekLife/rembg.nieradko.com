...
export const App = () => {
    return (
        <section className="bg-primary min-h-full flex py-12">
            <div className="mx-auto max-w-container px-4 md:px-8">
                <div className="flex flex-col justify-center text-center">
                    ...
                    <div className="mt-8 flex flex-col-reverse gap-3 w-full justify-center md:mt-8 md:flex-row md:self-center">
                        <PhotoProcessor />
                    </div>
                </div>
            </div>
